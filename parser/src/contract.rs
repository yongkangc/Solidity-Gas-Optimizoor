...
impl<'ast> Parser<'ast> {
    ...
    fn state_variable_declaration(&mut self) -> Option<ContractPartNode<'ast>> {
        ...
        for _ in 0..2 {
            match self.lexer.token {
                Token::KeywordPublic => {
                    self.unique_flag(&mut visibility, StateVariableVisibility::Public)
                }
                Token::KeywordInternal => {
                    self.unique_flag(&mut visibility, StateVariableVisibility::Internal)
                }
                Token::KeywordPrivate => {
                    self.unique_flag(&mut visibility, StateVariableVisibility::Private)
                }
    ...
    fn using_for_declaration(&mut self) -> Option<ContractPartNode<'ast>> {
        ...
        self.node_at(start, end, UsingForDeclaration { id, type_name })
    }
    ...
    fn struct_defintion(&mut self) -> Option<ContractPartNode<'ast>> {
        ...
        self.node_at(start, end, StructDefinition { name, body })
    }
    ...
    fn enum_definition(&mut self) -> Option<ContractPartNode<'ast>> {
        ...
        self.node_at(start, end, EnumDefinition { name, variants })
    }
}
...
mod test {
            ...
            [
                ...
                m.node(
                    ...
                    ContractDefinition {
                        ...
                        inherits: m.list([m.node(59, 66, "Amazing")]),
                        body: NodeList::empty(),
                    },
                ),
                m.node(
                    ...
                    ContractDefinition {
                        ...
                        inherits: m.list([m.node(99, 104, "Silly"), m.node(106, 111, "Kinda")]),
                        body: NodeList::empty(),
                    },
                ),
            ],
                        ...
                        m.node(
                            ...
                            StateVariableDeclaration {
                                ...
                                init: m.node(
                                    57,
                                    59,
                                    Primitive::IntegerNumber("10", NumberUnit::None),
                                ),
                            },
                        ),
                        m.node(
    ...
    // #[test]
    //     fn state_variable_declaration_array() {
    //         let m = Mock::new();
    ...
    //                                     45,
    //                                     54,
    //                                     ElementaryTypeName::Int(4, Some(10))
    //                                 ),
    //                                 visibility: None,
    //                                 constant: None,
    //                                 name: m.node(55, 58, "foo"),
    //                                 init: None,
    //                             },
    //                         ),
    //                         m.node(
    ...
    //                                     74,
    //                                     85,
    //                                     ElementaryTypeName::Byte(10, Some(5))
    //                                 ),
    //                                 visibility: m.node(86, 92, StateVariableVisibility::Public),
    //                                 constant: None,
    //                                 name: m.node(93, 97, "doge"),
    //                                 init: None,
    //                             },
    //                         ),
    //                     ]),
                        ...
                        m.node(
                            ...
                            ModifierDefinition {
                                ...
                                block: m.node(
                                    ...
                                    71,
                                    Block {
                                        body: m.list([m.node(67, 69, Statement::Placeholder)]),
                                    },
                                ),
                            },
                        ),
