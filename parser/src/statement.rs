use toolshed::list::{GrowableList, List, ListBuilder};

use crate::{Parser, StatementTypeNameContext, TOP};
use ast::*;
use lexer::Token;
...
pub trait StatementContext<'ast> {
    ...
    #[inline]
    fn pre_parse(_parser: &mut Parser<'ast>) -> Option<StatementNode<'ast>> {
        None
    }
}
...
impl<'ast> Parser<'ast> {
        ...
        Context: StatementContext<'ast>,
    {
        ...
        self.node_at(start, body.end, WhileStatement { test, body })
    }
        ...
        Context: StatementContext<'ast>,
    {
        ...
        self.node_at(start, end, DoWhileStatement { body, test })
    }
    ...
    fn inline_assembly_statement(&mut self) -> Option<StatementNode<'ast>> {
        ...
        self.node_at(start, block.end, InlineAssemblyStatement { string, block })
    }
        ...
        S: From<VariableDefinitionStatement<'ast>> + Copy,
    {
        ...
        self.node_at(
            ...
            VariableDefinitionStatement { declaration, init },
        )
    }
        ...
        S: From<InferredDefinitionStatement<'ast>> + Copy,
    {
        ...
        self.node_at(start, end, InferredDefinitionStatement { ids, init })
    }
                    ...
                    body: m.list([m.node(
                        ...
                        FunctionDefinition {
                            ...
                            block: m.node(
                                ...
                                102,
                                Block {
                                    body: m.list([m.stmt_expr(82, 83, 84, "_")]),
                                },
                            ),
                        },
                    )]),
                            ...
                            block: m.node(
                                ...
                                Block {
                                    body: m.list([
                                        ...
                                        m.node(109, 116, ReturnStatement { value: None }),
                                        m.node(
                                            137,
                                            148,
                                            ReturnStatement {
                                ...
                                Block {
                                    body: m.list([
                                        ...
                                        m.node(
                                            ...
                                            221,
                                            InferredDefinitionStatement {
                                                ids: m.list([None, None, m.node(203, 207, "skip")]),
                                                init: m.node(
                                                    211,
                                                    220,
                                                    TupleExpression {
